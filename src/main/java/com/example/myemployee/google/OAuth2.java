package com.example.myemployee.google;
 ...
 *
 * href="http://code.google.com/apis/accounts/docs/OAuth2Login.html">U sing
 * OAuth 2.0 for Login (Experimental)</a>.
 * https://github.com/google/google-api-java-clientsamples/blob/master/oauth2-cmdlinesample/src/main/java/com/google/api/services/samples/oauth2/cmdline
 * /OAuth2Sample.java
 *
 * @author Yaniv Inbar
 */
public class OAuth2 {
    ...
    private static Credential authorize() throws Exception {
        ...
        clientSecrets = GoogleClientSecrets.load(JSON_FACTORY,
                new InputStreamReader(OAuth2.class.getResourceAsStream("/client_secret.json")));
